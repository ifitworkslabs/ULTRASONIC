...
# === 👻 ANTI-GHOSTING & FINE-TUNING DASHBOARD 👻 ===
# 1. THE SQUELCH CONE (Degrees): Tighten this to suppress grating lobes!
# Since your TX array (4.2mm) focuses a very sharp beam, you only need to "listen" exactly where it points.
CONE_WIDTH = 4.0 

# 2. THE LOCK THRESHOLD: How sharp does the MUSIC peak need to be to drop a pin? (0.0 to 1.0)
VISUAL_THRESHOLD = 0.92 

# 3. THE NOISE FLOOR: Increase this if empty space is triggering random locks (e.g. 0.0001)
NOISE_FLOOR_THRESHOLD = 0.00008
...
if __name__ == '__main__':
    ...
    def update():
        while not data_queue.empty():
            ...
            cone_min = current_scan_angle - CONE_WIDTH
            cone_max = current_scan_angle + CONE_WIDTH
