...
ax.set_title("AESA Two-Way Pattern Multiplication (0-Degree Baseline)", color='white', fontsize=14, weight='bold')
...
tx_power = tx_power / np.max(tx_power) 

ax.plot(theta_scan, tx_power, color='#ff0000', linestyle='--', alpha=0.4, label='TX Array Factor (0°)')
line_final, = ax.plot(theta_scan, np.zeros(360), color='#00ff00', linewidth=3, label='Multiplied Spectrum')
